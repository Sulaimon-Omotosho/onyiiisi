  ...
  return (
    <div className='lg:py-20 px-3 md:px-10 xl:px-20'>
      ...
      <div className='flex flex-col items-center'>
        ...
        <button className='text-white bg-[rgb(95,40,74)] py-2 lg:py-3 w-[75%] md:w-[50%] lg:w-[30%] rounded-full uppercase font-bold text-md flex items-center justify-center gap-1 lg:gap-2 '>
