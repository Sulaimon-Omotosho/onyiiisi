...
const SingleProductPage = () => {
  ...
  // const fetchRelatedProducts = async (catName: string) => {
  //   try {
  //     const related = await productsByCategory(catName);
              ...
              <div className="flex flex-col gap-2">
                <h2 className="text-xl md:text-4xl font-semibold capitalize">
                  ...
                  {(product?.quantity ?? 0) < 5 && (
                    <span className="text-red-500 text-base font-md ml-2">
                      (item less than 5 in store)
                    </span>
                  )}
                </h2>
