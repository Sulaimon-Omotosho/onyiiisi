...
const SpecialsPage = () => {
  ...
  useEffect(() => {
    if (typeof specialsName === 'string') {
      const fetchProducts = async () => {
        try {
          const products = await productsBySpecial(specialsName)
        ...
        <div className='px-5 lg:px-20 py-10'>
          ...
          <div className='flex flex-col gap-5 md:flex-row md:gap-0 md:px-10 justify-between items-center'>
            <div className='flex gap-1'>
              ...
              <p className='font-semibold'> {specialsName}</p>
            </div>
            ...
            <div className='flex gap-5 items-center justify-end'>
              <div className='flex gap-1'>
                <Search placeholder={`Search ${specialsName}...`} />
              </div>
