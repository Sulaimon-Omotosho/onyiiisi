          ...
          <div className=' relative flex justify-center items-center w-full'>
            <div className=''>
              {feedbacks.map((feedback, idx) => (
                <div
                  key={idx}
                  className={`relative mx-3 h-[150px] w-[150px] overflow-hidden rounded-full border-2 border-yellow-700 ${
                    idx === currentIndex ? 'opacity-100' : 'opacity-0 hidden'
                  }
                `}
                >
            ...
            <div
              onClick={prevFeedback}
              className=' absolute left-1 md:left-32 xl:left-60 '
            >
              <ChevronLeft
                size={50}
            ...
            <div
              onClick={nextFeedback}
              className=' absolute right-1 md:right-32 xl:right-60'
            >
              <ChevronRight
                size={50}
                className='text-white drop-shadow-xl cursor-pointer'
